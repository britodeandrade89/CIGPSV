...
const HeaderLogo: React.FC<HeaderLogoProps> = ({ showSubtitle = true }) => (
  <div className="flex flex-col items-center justify-center font-black tracking-tighter select-none mb-4">
    ...
    {showSubtitle && (
      <span className="text-gray-200 text-[10px] md:text-sm font-normal mt-1 tracking-normal opacity-90 text-center">
